            ...
            <tr key={booking._id} style={{ borderBottom: '1px solid #e2e8f0', transition: 'background-color 0.2s' }}>
              ...
              <td style={{ padding: '12px', display: 'flex', gap: '8px', justifyContent: 'center' }}>
                {booking.status === 'Pending' && (
                  <>
                    <button 
                      ...
                      style={{ backgroundColor: '#22c55e', color: 'white', border: 'none', borderRadius: '6px', padding: '6px 12px', cursor: 'pointer', fontSize: '0.85rem' }}
                    >
                      Accept
                    </button>
                    <button 
                      onClick={() => handleStatusChange(booking._id, 'Cancelled')} 
                      style={{ backgroundColor: '#f59e0b', color: 'white', border: 'none', borderRadius: '6px', padding: '6px 12px', cursor: 'pointer', fontSize: '0.85rem' }}
                    >
                      Decline
                    </button>
                  </>
                ...
                <button 
                  ...
                  style={{ backgroundColor: '#ef4444', color: 'white', border: 'none', borderRadius: '6px', padding: '6px 12px', cursor: 'pointer', fontSize: '0.85rem' }}
                >
                  Delete
                </button>
              </td>
